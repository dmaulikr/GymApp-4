...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
    ...
    if let barFont = UIFont(name: "Avenir-Light", size: 24.0) {
      ...
      UINavigationBar.appearance().barTintColor = UIColor(red: 80/255, green: 81/255, blue: 79/255, alpha: 1.0)
    ...
    let attributes = [NSFontAttributeName: UIFont(name: "Avenir-Light", size: 12)]
    appearence.setTitleTextAttributes(attributes, for: .normal)
